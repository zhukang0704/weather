 ...
 * Time: 11:23
 */
namespace Zhukang\Weather\Tests;

use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use GuzzleHttp\Psr7\Response;
use Mockery\Matcher\AnyArgs;
use Zhukang\Weather\Exceptions\HttpException;
use Zhukang\Weather\Exceptions\InvalidArgumentException;
use Zhukang\Weather\weather;
